...
This action prints `Hello, World!` or `Hello, <jira-api>!` to the log. To
...
| -------------- | ------- | ------------------------------- |
| `jira-api` | `World` | The name of the person to greet |

## Outputs

| Output            | Description             |
| ------            | ----------------------- |
| `jira-api-output` | Jira output |
